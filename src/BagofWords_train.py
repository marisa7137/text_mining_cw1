...
def train(t, train_data, dev_data, num_classes):
    ...
    model = Model(pre_train_weight=None, vocab_size=len(t.vocab), embedding_dim=400, from_pre_train=False, freeze=False,
                    bow=True, hidden_dim_bilstm=300, hidden_layer_size=50, num_of_classes=num_classes)
