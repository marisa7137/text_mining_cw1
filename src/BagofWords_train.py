...
def plot_history(train_loss, train_accs, train_F1s, dev_loss, dev_accs, dev_F1s, num_classes, num_epoches):
    ...
    if num_classes == 6:
        loss_path = 'plotted_loss_bow_coase.png'
        acc_path = 'plotted_loss_bow_coase.png'
        f1_path = 'plotted_loss_bow_coase.png'
    else:
        loss_path = 'plotted_loss_bow_fine.png'
        acc_path = 'plotted_loss_bow_fine.png'
        f1_path = 'plotted_loss_bow_fine.png'
