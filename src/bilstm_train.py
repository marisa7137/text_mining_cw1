...
from bilstm_test import test_output
...
def train(t, train_data, dev_data, num_classes, pretrain, lr, epoch, batch, embedding_dim, hidden_dim, hidden_layer,freeze,output_file,pre_trained_weight=None):
    '''
